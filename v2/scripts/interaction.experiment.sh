...
parallel --ungroup \
  ...
  CAHRS_PROBLEM={9} \
  CAHRS_EVALUATION={10} \
  CAHRS_RECOMMEND_INTERACTION={11} \
  npm run run:mem \
  ::: `# MUTATION_RATE       ` 0.1 \
  ::: `# CROSSOVER_RATE      ` 0.9 \
  ...
  ::: `# INITIAL_DEPTH       ` 5 \
  ::: `# MAX_DEPTH           ` 6 \
  ::: `# EXPERIMENT_NAME     ` interaction \
  ::: `# PROBLEM             ` sobazaar-dense \
  ::: `# EVALUATION          ` mrr \
  ::: `# INTERACTION         ` product_detail_clicked content:interact:product_detail_viewed product_wanted purchase:buy_clicked
