...
export class RandomNodeConfig extends NodeConfig<RandomNodeProcessor> {
    ...
    protected processorFactory() {
        return new RandomNodeProcessor(this.config as WithGenerated<ConfigInterface>)
    }
}

export class RandomNodeProcessor extends NodeProcessor<WithGenerated<ConfigInterface>> {
